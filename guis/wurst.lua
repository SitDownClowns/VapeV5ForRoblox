...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function() return game:HttpGet('https://raw.https://raw.githubusercontent.com/SitDownClowns/VapeV5ForRoblox/usercontent.com/SitDownClowns/VapeV5ForRoblox/'..readfile('vape/profiles/commit.txt')..'/'..select(1, path:gsub('vape/', '')), true) end)
