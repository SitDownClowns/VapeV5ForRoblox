...
mainapi:CreateCategory({
	Name = 'Modules',
	Icon = getcustomasset('vape/assets/new/module.png')
})
	...
	Function = function(val, mouse)
		if mouse then
			...
			if shared.VapeDeveloper then
				...
				loadstring(game:HttpGet('https://raw.githubusercontent.com/SitDownClowns/VapeV5ForRoblox/'..readfile('vape/profiles/commit.txt')..'/loader.lua', true))()
			end
		end
	end,
